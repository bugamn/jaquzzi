...
/**
 * Class representing the real cos() function. It can operate on complex numbers, but only takes
 * the real part.
 * @see MathMap
 * @see Parse
 */
public class CosMap extends MathMap {
    private String data;
	...
	if (o instanceof Complex) {
	    return new Complex(Math.cos(((Complex)o).re()));
	}
