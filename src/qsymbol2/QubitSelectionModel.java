...
/**
 * This class copies a lot of the code of the original DefaultListSelectionModel. It
 * is not necessarily the fine art of object oriented programming, but since the
 * DefaultListSelectionModel declares a lot of the methods and variables private, that
 * was the simplest way to extend the model to "remember" the order of the selection
 * process as needed to encode the gates interactively.
 * <p>Basically, what was added is a PriorityQueue to keep track of the selection order.
 * The method getIndicesByPriority() returns the indices in the order of selection.
 * </p>
 * @see PriorityQueue
...
public class QubitSelectionModel implements ListSelectionModel, Cloneable, Serializable
{
    ...
    */
	...
	QubitSelectionModel clone = (QubitSelectionModel)super.clone();
